...
export default function Sidebar() {
  ...
  const onFinish = async (values) => {
    await createTask({ ...values, description: content, listUserAsign : assignees, projectId });
    setIsModalOpen(false);
    console.log("Success:", { ...values, description: content, listUserAsign : assignees, projectId });
  };
  ...
  const rules = {
    ...
    statusId: [{ required: true, message: "Please input your Status Project!" }],
    priority: [{ required: true, message: "Please input your Priority Project!" }],
  ...
  return (
    <>
      ...
      <div onClick={openDrawer} className="sm:hidden text-black z-10 flex items-center px-8 my-5 gap-3">
      ...
      <div className="px-5 sm:flex flex-col h-full justify-between hidden">
        <div className="flex gap-5 items-center px-5 bg-[#fff7ed] my-10">
          <div>
            <Link to="/"><h2 className="text-3xl font-semibold mb-2 text-prim-100">Jira Project</h2></Link>
        ...
        >
          ...
          <Menu.Item key="7" icon={<CalendarOutlined style={{ fontSize: 20 }} />}>
        ...
        <div className="mt-auto">
          <div className="flex items-center gap-3">
            <img className="rounded-full" src={curentUser.avatar || 'https://cdn.pixabay.com/photo/2017/01/31/21/23/avatar-2027366_1280.png'} alt="avatar" />
            <div>
        ...
        <div className="max-h-[740px] overflow-y-scroll create-task">
          ...
          >
            <div className="grid grid-cols-2 gap-5">
              <Form.Item label="Project" name="categoryId" rules={rules.category} >
                <Select
                  showSearch
                  ...
                  options={projects.map(e => ({ value: e.id, label: e.projectName }))}
                />
              </Form.Item>
              <Form.Item
                label="Task Name"
              ...
              >
                <Select
                  ...
                  options={status.map(e => ({ value: e.statusId, label: e.statusName }))}
                />
              </Form.Item>
              <Form.Item
                label="Priotity"
              ...
              >
                <Select
                  ...
                  options={priority.map(e => ({ value: e.priorityId, label: e.priority }))}
                />
              </Form.Item>
              <Form.Item
                label="Type Task"
              ...
              >
                <Select
                  ...
                  options={taskType.map(e => ({ value: e.id, label: e.taskType }))}
                />
              </Form.Item>
              </div>
              <Form.Item
      ...
      <Drawer placement="right" width="270" onClose={closeDrawer} open={drwaer}>
