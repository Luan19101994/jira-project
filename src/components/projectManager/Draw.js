...
function Draw() {
  ...
  const { showDetail, setShowDetail, project, categories, setCategories } = useContext(ProjectManagerContext);
  const [content, setContent] = useState("");
  const rules = {
    category: [{ required: true, message: "Please input your Category Project!" }],
    projectName: [{ required: true, message: "Please input your Name Project!" }],
  };
  ...
  useEffect(() => {
    ...
    fetchCategory()
  },[project.description, setCategories, project.categoryName,project.projectName, form]);
  return (
      ...
      >
          ...
          <div className="grid grid-cols-2 gap-3 mt-5">
            <div className="col-span-1">
              ...
              <Input placeholder="Name Project"  defaultValue={project.projectName}/>
              </Form.Item>
            </div>
            <div className="col-span-1">
        ...
        <Button className="w-32 !h-10 mt-5 text-black" type="container" onClick={() => setShowDetail(false)}>
          Cancel
        </Button>
